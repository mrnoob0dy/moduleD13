...
from .models import User, Post, Category, EmailVerification, Comment
...
#     title = forms.CharField(widget=forms.TextInput(attrs={'class': 'form-control py-4', 'placeholder': 'Введите заголовок'}))
#     category = forms.ModelMultipleChoiceField(queryset=Category.objects.all(), widget=forms.Select(attrs={'class': 'form-control py-4', 'placeholder': 'Выберите категорию'}))
#     description = forms.CharField(widget=forms.TextInput(attrs={'class': 'form-control py-4', 'placeholder': 'Введите описание'}))
#     class Meta:
#         model = Post
