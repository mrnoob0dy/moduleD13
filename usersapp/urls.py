...
urlpatterns = [
    ...
    path('verify/<str:email>/<uuid:code>/', EmailVereficationView.as_view(), name='email_verefication'),
    path('comments/<int:pk>/comment_create', CommentCreateView.as_view(), name='comment_create'),
